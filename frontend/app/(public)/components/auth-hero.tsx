...
// PIP logo mark — minimal geometric mark in brand green
function PipMark({ size = 33 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="2" y="2" width="12" height="12" rx="2" fill="#0fff5d" opacity="0.9" />
      <rect x="19" y="2" width="12" height="12" rx="2" fill="#0fff5d" opacity="0.5" />
      <rect x="2" y="19" width="12" height="12" rx="2" fill="#0fff5d" opacity="0.5" />
      <rect x="19" y="19" width="12" height="12" rx="2" fill="#0fff5d" opacity="0.9" />
    </svg>
  );
}
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Search HR, Confluence, SharePoint &amp; more
          </Text>
        </Flex>
      </Box>
